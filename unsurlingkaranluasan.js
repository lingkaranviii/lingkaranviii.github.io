...
function myFunction13() {
  ...
  function mm6() {
    ...
    var jawaban;
    if (x == "60") {
      jawaban = "<img class='ikon1' src='benar.png'  width='25px' height='25px'> \\[\\,\\,dan\\,\\,bertolak\\,\\,belakang\\,\\,dengan\\,\\,\\angle WCZ\\]"
    } else if ( x == "") {
      jawaban = "\\[\\,\\,dan\\,\\,bertolak\\,\\,belakang\\,\\,dengan\\,\\,\\angle WCZ\\]";
    } else {
      jawaban = "<img class='ikon1' src='salah.png'  width='25px' height='25px'> \\[\\,\\,dan\\,\\,bertolak\\,\\,belakang\\,\\,dengan\\,\\,\\angle WCZ\\]";
    }
